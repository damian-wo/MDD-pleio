...
results1 <- userGWAS(covstruc = LDSCoutput, SNPs = genes, model = model1, sub=c("F_gastro_MDD ~ Gene"), estimation = "DWLS", parallel = FALSE, TWAS = TRUE)

out1 <- paste0("./3_gastro/Gastro_", tissue, "TSEM")
...
out2 <- paste0("./3_gastro/Gastro_", tissue, "_independent_TSEM")
